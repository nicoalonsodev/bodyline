...
const TherapyCard = ({ image, title, description, pdfLink, logo }) => {
  return (
          ...
          <img src={logo} alt="" className='w-1/2 mb-2' />
            ...
            {pdfLink && (
              <a
                href={pdfLink}
                download
                className="mt-4 inline-block bg-white text-[#00314b] font-poppins py-2 px-4 rounded-full text-sm border border-[#00314b] hover:bg-[#00314b] hover:text-white transition"
              >
                Descargar PDF
              </a>
            )}
