    ...
    <footer className={`text-white ${className || "bg-[#00314b]"}`}>
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="relative h-25 w-40">
              <Image
                src={isRetiroUno ? "/assets/retiro-uno/logo-beige.png" : "/assets/logo-vertical.png"}
            ...
            <p className="text-gray-300 font-clash-400">
              {isRetiroUno
                ? "Experiencias conscientes, nutrición plant-based y conexión con la naturaleza en nuestro retiro UNO."
            ...
            <ul className="space-y-2">
              {isRetiroUno ? (
                ...
                <>
                  ...
                  <li>
                    <Link href="/retiro-uno/politicas" className="text-gray-300 hover:text-white transition-colors">
                      Políticas
                    </Link>
                  </li>
                </>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-300">{isRetiroUno ? "uno.retiros@gmail.com" : "info@bodyline.com"}</span>
              </li>
              {isRetiroUno ? (
                ...
                <>
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-300">Pily | +54 9 1135790710</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Phone size={18} className="mt-1 flex-shrink-0" />
                    <span className="text-gray-300">Irene | +54 9 299 6302273</span>
                  </li>
                </>
              ) : (
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400 font-clash-400">
          <p>
            © {new Date().getFullYear()} {isRetiroUno ? "Retiro UNO" : "Bodyline"}. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
